...
import 'package:flutter/foundation.dart' show debugPrint, describeEnum, kIsWeb;

enum PlatformType { android, ios, linux, web, macos, windows, etc }
  ...
  static Future<Map<String, dynamic>> deviceData() async {
    try {
      switch (platformType()) {
        ...
        default:
          return {"Error": "We don't know platform type"};
      }
    } catch (e) {
      debugPrint("Something problem happen: $e");
      return {"Error": e};
    }
  }
